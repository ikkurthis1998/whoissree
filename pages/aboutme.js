			...
			<div className="flex flex-col justify-start items-center w-screen mt-32 mb-24">
				...
				<div className="flex flex-col p-5 mobile-sm:w-11/12 computer:w-3/5">
					...
					<div className="mobile-sm:text-base mobile-md:text-lg tablet:text-xl flex flex-wrap">
						<p className="rounded-lg mobile-sm:m-1 mobile-md:m-2 bg-blue-500 text-white mobile-sm:px-1 mobile-md:px-5 border-2 mobile-sm:w-28 mobile-md:w-32 tablet:w-36 text-center h-10 flex justify-center items-center">
							React JS
						</p>
						<p className="rounded-lg mobile-sm:m-1 mobile-md:m-2 bg-blue-500 text-white mobile-sm:px-1 mobile-md:px-5 border-2 mobile-sm:w-28 mobile-md:w-32 tablet:w-36 text-center h-10 flex justify-center items-center">
							Express JS
